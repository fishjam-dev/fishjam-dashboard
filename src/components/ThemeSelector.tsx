...
export const isThemeType = (value: string | undefined | null): value is Theme => value === "dark" || value === "white";
...
export const ThemeSelector = () => {
  const [currentTheme, setCurrentTheme] = useState<Theme>(getLastSelectedTheme());
